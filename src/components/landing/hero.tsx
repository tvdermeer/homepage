    ...
    <section className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden px-4 text-center">
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <p className="mx-auto mb-10 max-w-xl text-lg text-slate-400">
          Exploring the intersection of artificial intelligence and the game of golf.
          Building intelligent solutions on and off the course.
        </p>
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/cv"
            className="inline-flex items-center justify-center rounded-lg border border-slate-700 bg-slate-900 px-6 py-3 text-sm font-semibold text-white hover:bg-slate-800 transition-colors"
          >
            View My CV
          </Link>
        </div>
